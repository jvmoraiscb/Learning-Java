...
class Pokemon implements PersonagemDeLuta<Pokemon>{
	...
	private int vitalidade_atual;
	private int dano_minimo;
	private int dano_maximo;
	
	public Pokemon(int vitalidade, int dano_minimo, int dano_maximo){
		this.vitalidade 		= vitalidade;
		this.vitalidade_atual 	= vitalidade;
		this.dano_minimo 		= dano_minimo;
		this.dano_maximo 		= dano_maximo;
	}
	...
	public boolean atacar(Pokemon personagemAtacado) {
		Random r = new Random();
 		if(r.nextBoolean()){
			personagemAtacado.vitalidade_atual -= dano_maximo;
		}
		else{
			personagemAtacado.vitalidade_atual -= dano_minimo;
		}

		if(personagemAtacado.vitalidade_atual == 0)
			return true;
		return false;
	}
	...
	@Override
	public void regenera() {
		this.vitalidade_atual = this.vitalidade;
	}

	@Override
	public int getPontosVitalidade() {
		return this.vitalidade_atual;
	}
}
